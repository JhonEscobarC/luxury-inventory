...
import { obraEtapasRouter } from "./modules/obraEtapas/obraEtapas.routes";
...
import { abonosClienteRouter } from "./modules/abonosCliente/abonosCliente.routes";
import { gastosAdicionalesRouter } from "./modules/gastosAdicionales/gastosAdicionales.routes";
...
app.use("/api/obra-etapas", obraEtapasRouter);
...
app.use("/api/abonos-cliente", abonosClienteRouter);
app.use("/api/gastos-adicionales", gastosAdicionalesRouter);
